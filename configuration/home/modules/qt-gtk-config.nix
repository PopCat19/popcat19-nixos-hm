# qt-gtk-config.nix
#
# Purpose: Configure XDG MIME defaults and GTK/Qt application integrations
#
# This module:
...
{ userConfig, ... }:
{
  ...
  home.file = {
    ...
    ".local/share/applications/${userConfig.defaultApps.editor.package}.desktop".text = ''
      [Desktop Entry]
      Version=1.0
      Type=Application
    ...
    ".local/share/applications/${userConfig.defaultApps.terminal.package}.desktop".text = ''
      [Desktop Entry]
      Version=1.0
      Type=Application
    ...
    ".local/share/nemo/actions/edit-as-root.nemo_action".text = ''
      [Nemo Action]
      Name=Edit as Root
    ...
    ".local/share/nemo/actions/open-in-kitty.nemo_action".text = ''
      [Nemo Action]
