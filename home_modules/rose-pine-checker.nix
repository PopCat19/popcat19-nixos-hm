# ~/nixos-config/modules/rose-pine-checker.nix
# Rose Pine Theme Status Checker Module
# Provides a utility script to verify Rose Pine theming is working correctly
