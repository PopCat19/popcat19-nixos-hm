# thinkpad0 Profile Home Configuration
#
# Purpose: Home Manager configuration for the thinkpad0 profile
# Dependencies: configuration/home/home.nix, user-config.nix
# Related: profiles/thinkpad0/main_configuration/configuration.nix
#
# This module:
