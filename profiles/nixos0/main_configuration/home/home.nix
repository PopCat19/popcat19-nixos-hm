# nixos0 Profile Home Configuration
#
# Purpose: Home Manager configuration for the nixos0 profile
# Dependencies: configuration/home/home.nix, user-config.nix
# Related: profiles/nixos0/main_configuration/configuration.nix
#
# This module:
