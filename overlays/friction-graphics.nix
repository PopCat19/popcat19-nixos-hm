# friction-graphics.nix
#
# Purpose: Build Friction vector motion graphics application
#
# This module:
# - Builds friction from source with Qt5 dependencies
# - Supports optional Wayland mode
{
  lib,
  clangStdenv,
  cmake,
