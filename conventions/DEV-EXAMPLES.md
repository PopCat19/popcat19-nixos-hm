...
```fish
begin; command -v rg &>/dev/null; and rg "graphical-session" ~/popcat19-nixos-hm --type nix -n; or grep -rn "graphical-session" ~/popcat19-nixos-hm --include="*.nix"; end | wl-copy
```
