...

{
  ...
  # Fish configuration moved to system level (configuration.nix)
  # This ensures root and other system users have access to the same shell configuration

  # Starship Prompt: moved to system level (configuration.nix) for all users
  # This ensures root and other system users have access to the same prompt
  programs.starship = {
    enable = false;
    settings = {
  ...
  # Fish functions and themes moved to system level (/etc/fish/)
  # User-specific fish themes still available through home directory
