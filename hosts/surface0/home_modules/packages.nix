# Surface-specific Home Manager package configuration (cloned from ../../home_modules/packages.nix)
# This file is intended for surface0-specific package overrides. Keep synchronized with
# ../../home_modules/packages.nix and add surface-specific entries below as needed.
{
  pkgs,
  inputs,
  system,
